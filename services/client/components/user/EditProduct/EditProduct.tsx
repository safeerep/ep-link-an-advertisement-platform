...
const EditProduct = () => {
    ...
    const imagesArray = new Array(8).fill(null)
    ...
    const handleImageChange = (index: number, e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            setImageFiles((prevImageFiles) => {
                const nextNullIndex = imageUrls.indexOf(null);
                const newImageFiles = { ...prevImageFiles };
                if (nextNullIndex !== -1) {
                    newImageFiles[nextNullIndex] = file;
            ...
            setImageUrls((prevImageUrls) => {
                const nextNullIndex = prevImageUrls.indexOf(null);
                const newImageUrls = [...prevImageUrls];
                if (nextNullIndex !== -1) {
                    newImageUrls[nextNullIndex] = imageUrl;
                    return newImageUrls;
                }
                else {
